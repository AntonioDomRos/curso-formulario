...
export default function PerfilUpdateForm(props) {
  const {
    id: idProp,
    perfil: perfilModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = perfilRecord
      ? { ...initialValues, ...perfilRecord }
      : initialValues;
  ...
  const [perfilRecord, setPerfilRecord] = React.useState(perfilModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Perfil, idProp)
        : perfilModelProp;
      setPerfilRecord(record);
    };
    queryData();
  }, [idProp, perfilModelProp]);
  React.useEffect(resetStateValues, [perfilRecord]);
  const validations = {
    nombre: [],
    apellido: [],
    municipio: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Perfil.copyOf(perfilRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "PerfilUpdateForm")}
      {...rest}
    >
      <TextField
        label="Nombre"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || perfilModelProp)}
